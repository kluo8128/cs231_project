% [im] = getMultiBand(warpedImages, warpedWeights)
%
...
function [im] = getMultiBand(warpedImages, warpedWeights) % assumes all images same size
m = 2;
...
% Gaussian pyramid
for i = 1:k
    gauss{i,1} = double(warpedImages{i}) ./ 256;
